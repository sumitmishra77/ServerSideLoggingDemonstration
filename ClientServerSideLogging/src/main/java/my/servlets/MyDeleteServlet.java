 ...
 * @author mishr
 */
@WebServlet(name = "MyDeleteServlet", urlPatterns = {"/MyDeleteServlet"})
public class MyDeleteServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        EmpInfoImplService info= new EmpInfoImplService ();
                 ...
                 List<Employee> empList=empInfo. deleteEmp(request.getParameter("id"));
                  String display;
                  if(empList.isEmpty()){
                      display="Delete Not performed Employee not found  ";
                  }
                  else{
                      
                  
                 
                 display="<h1>Employee Information</h1><table border='1'><tr><th>EmpNo<th>Name</th><th>JobTitle</th></tr>";
