 ...
 * @author mishr
 */
@WebServlet(name = "MyDisplayAllServlet", urlPatterns = {"/MyDisplayAllServlet"})
public class MyDisplayAllServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        PrintWriter out = response.getWriter();
                 ...
                 List<Employee> empList=empInfo.getAllEmp();
                          
                 
                 String display="<table border='1'><tr><th>EmpNo<th>Name</th><th>JobTitle</th></tr>";
